...
const variantStyles: Record<ButtonVariant, string> = {
  primary: [
    ...
    'active:bg-[var(--btn-primary-bg-active)] active:scale-[0.97]',
    'transition-[background-color,transform,box-shadow] duration-[220ms] ease-[cubic-bezier(0.33,1,0.68,1)]',
  ].join(' '),
  secondary: [
    ...
    'active:scale-[0.97]',
    'transition-[background-color,border-color,transform,box-shadow] duration-[220ms] ease-[cubic-bezier(0.33,1,0.68,1)]',
  ].join(' '),
  ghost: [
    'text-sb-ink-muted font-medium',
    'hover:text-sb-ink hover:bg-surface-2',
    'active:bg-surface-3 active:scale-[0.97]',
    'transition-[color,background-color,transform] duration-[220ms] ease-[cubic-bezier(0.33,1,0.68,1)]',
  ].join(' '),
  danger: [
    ...
    'transition-[background-color,border-color,opacity,transform] duration-[220ms] ease-[cubic-bezier(0.33,1,0.68,1)]',
  ].join(' '),
}
