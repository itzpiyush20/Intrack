    ...
    >
      ...
      <div className="prose max-w-none space-y-10">
        ...
        {section("2. What Data We Collect", null, [
          ...
          { title: "Email Content (Gmail Only)", body: "If you connect Gmail, we use a read-only OAuth scope and search your inbox for financial keywords. To decide whether a matching email is a real transaction, its subject and body are read in your browser — this necessarily includes emails that turn out to be newsletters or promotions, which are then discarded. When our AI classifier is used, at most 1,500 characters of that text are sent to our server and on to Google Gemini; the rest never leaves your device. We do not store the body of any email. Only the extracted transaction data is saved permanently." },
